...
A curated list of research internships and programs for international students, particularly in CS, tech, math, and bio. Started this as I was looking for opportunities myself and figured it'd help others too.

Open to contributions! If you know of programs that accept international students, feel free to submit a PR.
...
| [NTU Global Connect Fellowship (GCF)](https://www.ntu.edu.sg/about-us/global/global-connect-fellowship) | Nanyang Technological University | Singapore | All disciplines (AI, Materials, Cybersecurity, Life Sciences, Humanities, Engineering, etc.) | Jan | Jul 1–Aug 31, 2026; BSc/MSc graduating 2026–27; SGD 5,000 stipend + accommodation |
| [KEK SOKENDAI Summer Student Program](https://www.kek.jp/en/education/sokendai/ssp) | KEK / SOKENDAI | Japan (Tsukuba / Tokai/J-PARC) | Particle Physics, Nuclear Physics, Materials/Life Science, Accelerator Science, Detector Tech | Feb| Mid-Jun to mid-Aug 2026, up to 8 weeks; BSc (≥3rd yr) & MSc; airfare, dorm, per diems covered |
| [GIST Global Intern Program (GIP)](https://www.gist.ac.kr/en/html/sub07/0702.html) | Gwangju Institute of Science and Technology | South Korea (Gwangju) | Engineering, Life Sciences, CS, Physics, Chemistry, Nanotechnology, Environmental Sciences | Feb | Jul–Aug 2026, 8 weeks; international UG seniors & master's; fully funded (50% airfare, dorm, stipend, Korean classes) |
| [DGIST Summer Research Internship for International Undergraduates](https://www.dgist.ac.kr/) | Daegu Gyeongbuk Institute of Science and Technology | South Korea (Daegu) | Physics/Chemistry, EECS, Robotics, Energy, Brain Sciences, New Biology, Interdisciplinary | March | Jun 29–Aug 7, 2026 (6 weeks); 3rd–4th yr UG; GPA ≥3.0; scholarship + dorm + daily allowance |
| [Academia Sinica TIIP (Taiwan International Internship Program)](https://tigp.sinica.edu.tw/pages/3127) | Academia Sinica | Taiwan (Taipei) | Life Sciences, Bioinformatics, Earth Science, Nano, AI, Chemistry, Social Sciences | Dec 15–Jan 15 (annual) | 2 months; 3 cohorts (May–Jun, Jun–Jul, Jul–Aug); final-yr UG, MS, or recent grads; NTD 30,000/mo + partial airfare |
...
| Program | Institution | Location | Fields | Deadline | Notes |
|---------|------------|----------|--------|----------|-------|
| [CERN Summer Student Program](https://home.web.cern.ch/summer-student-programme) | CERN | Switzerland | Physics, Engineering, CS | Jan | Highly competitive |
| [EPFL SV Summer Research](https://www.epfl.ch/schools/sv/education/summer-research-program/how-to-apply/) | EPFL | Switzerland | Life Sciences | November | |
| [Max Planck Internships](https://www.cis.mpg.de/internships/) | Max Planck Institute | Germany | CS, Information Systems | November | Multiple locations |
| [HZDR Internship](https://www.hzdr.de/db/Cms?pNid=2914) | Helmholtz-Zentrum | Germany | Physics, Engineering | Feb | |
...
| [Swiss Summer Student Program in Particle Physics (S3P3)](https://swiss.sspp.program.phys.ethz.ch/HowToApplySwissSchool.html) | ETH Zurich / Univ. Zurich / EPFL / Univ. Bern | Switzerland | Physics, Particle Physics, Applied Physics | TBA ~Mar 2026 (check site) | Jul 13–Sep 13, 2026; BSc (≥3rd yr) & MSc; merit-based scholarships via CHIPP/SCNAT; covers living expenses, travel, health insurance |
| [EEML – Eastern European Machine Learning Summer School](https://www.eeml.eu/home) | EEML / Google DeepMind | Montenegro (Cetinje) | Machine Learning, AI, Deep Learning | **Mar 31, 2026** | Jul 27–Aug 1, 2026; open to students, researchers worldwide; competitive selection |
| [OzU Undergraduate Research Summer Program 2026](https://www.ozyegin.edu.tr/en/research/summer-research-program/undergraduate-research-summer-internship-program/undergraduate) | Özyeğin University | Turkey (Istanbul) | Engineering, CS, AI, Wireless Comms, Robotics, Business, Social Sciences, Materials | TBA (check site) | Summer 2026; open to international undergrads; project-based across multiple departments |
...
| Program | Institution | Location | Fields | Deadline | Notes |
|---------|------------|----------|--------|----------|-------|
| [Mitacs Globalink](https://www.mitacs.ca/our-programs/globalink-research-internship-students/) | Various Universities | Canada | Multiple | Sept | Usually summers |
| [Rockefeller SURF](https://www.rockefeller.edu/education-and-training/surf/application-information/) | Rockefeller University | USA | Biosciences | Feb | 10 weeks, stipend provided |
| [Caltech SURF](https://sfp.caltech.edu/undergraduate-research/programs/surf) | Caltech | USA | Multiple | Feb | Competitive |
| [Amgen Scholars Program](https://amgenscholars.com/) | Multiple Universities | USA, Europe, Asia | STEM | Usually Feb | Multiple locations |
| [Brown ICERM](https://icerm.brown.edu/summerug) | Brown University | USA | Mathematics | Feb | Math REU |
| [Purdue SURF](https://engineering.purdue.edu/Engr/Research/EURO/students/about-SURF) | Purdue University | USA | Engineering | Jan | |
| [Rutgers Aresty RISE](https://aresty.rutgers.edu/programs-funding/the-research-intensive-summer-experience) | Rutgers | USA | Multiple | Feb | |
| [ASU SURI](https://students.engineering.asu.edu/graduate/research/suri/) | Arizona State | USA | Engineering | Feb | |
| [WashU McKelvey ISRI (International Student Research Internship)](https://engineering.washu.edu/academics/undergraduate-research/international-student-research-internship-program.html) | Washington University in St. Louis | USA (St. Louis, MO) | Biomedical Eng, CS/AI, Electrical Eng, Chemical Eng, Mech Eng, Materials, Synthetic Biology | Nov| May–Aug 2026, 10 weeks; penultimate-yr international UG only (non-US citizens); USD 3,000 stipend + free housing + transit pass |

### Special Programs

| Program | Type | Fields | Deadline | Notes |
|---------|------|--------|----------|-------|
| [Polymath Jr](https://geometrynyc.wixsite.com/polymathreu) | Remote/Virtual | Mathematics | April | Undergrads with experience in writing proofs |
...
Found a program that accepts international students? Please submit a PR with:
- Program name and link
- Institution and location
- Fields of study
- Typical deadline
- Any important notes (funding, duration, eligibility)

## Notes

- Deadlines are approximate and vary year to year so, always check official websites
- Most programs require you to be currently enrolled as an undergraduate
- Some programs may have citizenship restrictions despite accepting international students, read carefully

---

*Maintained as an open-source contribution to help international students find research opportunities.*
